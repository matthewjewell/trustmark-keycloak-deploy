<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false>
    ...
    <main class="${properties.kcLoginClass!}">
        <div id="kc-header" class="${properties.kcHeaderClass!} navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <ul class="navbar-nav me-auto">
                    <li id="kc-header-wrapper"
                        class="${properties.kcHeaderWrapperClass!} nav-item nav-link fw-bold pe-4">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</li>
                </ul>
            </div>
        </div>
        <div class="${properties.kcFormCardClass!}">
            ...
            <div class="container pt-4">
                <div class="row">
                    <div class="col-12">
                        <img src="${url.resourcesPath}/images/tmi-header.png" height="90em"/>
                    </div>
                </div>
            </div>

            <header class="${properties.kcFormHeaderClass!} container pt-4" style="max-width: 540px">
